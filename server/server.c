...
/*   Updated: 2022/02/25 15:44:33 by ldatilio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "server.h"

static void	change_route(struct mg_connection *c, struct mg_http_message *hm,
						char *route)
{
	char	*body;
